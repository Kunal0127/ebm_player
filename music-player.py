...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/de project final mayby/ebm_player/prediction/static/songs/","")
...
def Play():
    ...
    song=f'C:/de project final mayby/ebm_player/prediction/static/songs/{song}'
...
def Previous():
    ...
    temp2=f'C:/de project final mayby/ebm_player/prediction/static/songs/{temp2}'
...
def Next():
    ...
    temp=f'C:/de project final mayby/ebm_player/prediction/static/songs/{temp}'
